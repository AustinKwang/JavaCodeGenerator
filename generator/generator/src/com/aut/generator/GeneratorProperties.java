...
import com.aut.generator.util.PropertiesHelper;
import com.aut.generator.util.PropertyPlaceholderHelper;
import com.aut.generator.util.PropertyPlaceholderHelper.PropertyPlaceholderConfigurerResolver;
import com.aut.generator.util.typemapping.DatabaseTypeUtils;
...
public class GeneratorProperties {
	...
	private static ArrayList<String> PROPERTIES_FILE_NAMES = new ArrayList<String>();
	private static boolean HAS_LOAD_PROPS = false;
	static PropertiesHelper props = new PropertiesHelper(new Properties(),true);
	private GeneratorProperties(){}
	static {
		PROPERTIES_FILE_NAMES.add("generator.properties");
		reload();
	}
	
	public static void addProperFileName(String fileName){
		PROPERTIES_FILE_NAMES.add(fileName);
		reload();
	}
	public static void reload() {
		try {
			String[] propFiles = PROPERTIES_FILE_NAMES.toArray(new String[PROPERTIES_FILE_NAMES.size()]);
			GLogger.println("Start Load GeneratorPropeties from classpath:" + Arrays.toString(propFiles));
			Properties p = new Properties();
			String[] loadedFiles = PropertiesHelper.loadAllPropertiesFromClassLoader(p, propFiles);
