package com.picc.generator.provider.db.table.model;
...
public class Table implements java.io.Serializable,Cloneable {
	...
	public Table(Table t) {
		...
		this.classname2 = t.getClassname2();
	...
	public String getClassNameFirstLower2() {
		return StringHelper.uncapitalize(getClassname2());
	}
		...
		if(getPkCount()>0){//存在主键
			...
			for(Column c : getColumns()) {
				if(c.isPk()){
					...
					.append("\", column = @Column(name = \"").append(c.getSqlName())
					.append("\")),");
				}
			}
   ...
   public Column getRequiredColumnBySqlName(String sqlName) {
	...
	public String getClassname2() {
		if(StringHelper.isBlank(classname2)) {
	        String removedPrefixSqlName = removeTableSqlNamePrefix(sqlName);
//	        if(removedPrefixSqlName.toLowerCase().startsWith("t_"))
//	        {
//	        	removedPrefixSqlName = removedPrefixSqlName.substring(2);
//	        }
//	        else if(removedPrefixSqlName.toLowerCase().startsWith("m_"))
//	        {
//	        	removedPrefixSqlName = removedPrefixSqlName.substring(2);
//	        }
//	        else if(removedPrefixSqlName.toLowerCase().startsWith("hd_"))
//	        {
//	        	removedPrefixSqlName = removedPrefixSqlName.substring(3);
//	        }
//	        else if(removedPrefixSqlName.toLowerCase().startsWith("wx_"))
//	        {
//	        	removedPrefixSqlName = removedPrefixSqlName.substring(3);
//	        }
//	        else if(removedPrefixSqlName.toLowerCase().startsWith("sys_"))
//	        {
