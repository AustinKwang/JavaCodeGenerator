...
import com.picc.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import com.picc.generator.provider.db.table.model.util.ColumnHelper;
import com.picc.generator.util.GLogger;
import com.picc.generator.util.StringHelper;
import com.picc.generator.util.TestDataGenerator;
import com.picc.generator.util.typemapping.ActionScriptDataTypesUtils;
import com.picc.generator.util.typemapping.DatabaseDataTypesUtils;
import com.picc.generator.util.typemapping.JavaPrimitiveTypeMapping;
...
public class Column implements java.io.Serializable,Cloneable{
	...
	public String getMybatisSqlTypeName()
	{
		if("INT".equalsIgnoreCase(_sqlTypeName))
		{
			return "INTEGER";
		}
		else if("TEXT".equalsIgnoreCase(_sqlTypeName))
		{
			return "VARCHAR";
		}
		return _sqlTypeName;
